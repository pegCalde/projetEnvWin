...
namespace projetEnvWin
{
    ...
    /// </summary>
    public sealed partial class FrOrthoPage : Page
    {
        ...
        public async void generateQuestions()
        {
            ...
            Partie ortho = francais.ListePartie[3];
            Grid tmp = new Grid();


            foreach (Question q in ortho.ListeQuestion)
            {
        ...
        private void btnValider_Click(object sender, RoutedEventArgs e)
        {
            foreach (Grid g in form.Children)
            {
                ...
                Question Qattributed = francais.ListePartie[3][tmp.Text];
